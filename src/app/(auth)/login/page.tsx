...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      {/* Background orbs */}
      <div className="absolute top-1/4 -left-32 w-96 h-96 bg-[hsl(217,91%,60%,0.06)] rounded-full blur-[120px]" />
      <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-[hsl(263,70%,50%,0.06)] rounded-full blur-[120px]" />
      ...
      >
        ...
        <div className="glass-strong rounded-2xl p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 text-sm font-medium text-white hover:bg-white/10 transition-all mb-6"
          >
        ...
        <p className="text-center text-sm text-white/30 mt-6">
          ...
          <Link href="/register" className="text-[hsl(217,91%,60%)] hover:underline">
            Create one
          </Link>
        </p>
      </motion.div>
